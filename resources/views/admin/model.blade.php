            ...
            <table class="center">
              ...
              <tr>
                ...
                <td>
                  ...
                  <form action="{{url('delete_model',$item->id)}}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
                    <button type="submit" onclick="return confirm('Are you sure you want to delete this model?')" class="btn btn-danger">Delete</button>
                  </form>
