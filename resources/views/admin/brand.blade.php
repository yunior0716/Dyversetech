            ...
            <table class="center">
              ...
              <tr>
                ...
                <td>
                  ...
                  <form action="{{url('delete_brand',$data->id)}}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
                    <button type="submit" onclick="return confirm('Are you sure you want to delete this brand?')" class="btn btn-danger">Delete</button>
                  </form>
